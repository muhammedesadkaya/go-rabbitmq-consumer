...
func errorPublishMessage(payload []byte, retryCount int, err error, stackTracing string) amqp.Publishing {
...
func publishMessage(payload interface{}) (amqp.Publishing, error) {
